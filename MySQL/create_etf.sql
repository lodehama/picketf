CREATE TABLE etf (
  ...
  etf_fx_hedged TINYINT NOT NULL DEFAULT 0          -- 0: 비헤지, 1: 환헤지
);
...
VALUES
-- 일반 1배수 (비헷지)
('M10', '381170', 'TIGER 미국테크TOP10 INDXX', '미래에셋자산운용', 1.0, 0),
('M10', '490090', 'TIGER 미국AI빅테크10', '미래에셋자산운용', 1.0, 0),
('M10', '485540', 'KODEX 미국AI테크TOP10', '삼성자산운용', 1.0, 0),
('M10', '465580', 'ACE 미국빅테크TOP7 Plus', '한국투자신탁운용', 1.0, 0),
('M10', '481190', 'SOL 미국테크TOP10', '신한자산운용', 1.0, 0),
('M10', '461900', 'PLUS 미국테크TOP10', '한화자산운용', 1.0, 0),

-- 일반 1배수 (환헤지)
('M10', '472160', 'TIGER 미국테크TOP10 INDXX(H)', '미래에셋자산운용', 1.0, 1),
('M10', '314250', 'KODEX 미국빅테크10(H)', '삼성자산운용', 1.0, 1),

-- 레버리지 2배 (비헷지)
('M10', '465610', 'ACE 미국빅테크TOP7 Plus레버리지(합성)', '한국투자신탁운용', 2.0, 0),
('M10', '461910', 'PLUS 미국테크TOP10레버리지(합성)', '한화자산운용', 2.0, 0);
...
('SPACE', '0180V0', 'ACE 미국우주테크액티브', '한국투자신탁운용', 1.0, 0);
